...
\author{John Fox}
\date{Version 2.7-0 (last modified: 2020-08-10)}
\maketitle
...
see \citet{Fox17}, which has a website at <\href{https://socserv.mcmaster.ca/jfox/Books/RCommander/}{socserv.mcmaster.ca/jfox/Books/RCommander/}> 
or <\href{https://tinyurl.com/RcmdrBook}{tinyurl.com/RcmdrBook}>.
...
<\href{https://socserv.socsci.mcmaster.ca/jfox/Misc/Rcmdr/index.html}{socserv.socsci.mcmaster.ca/jfox/Misc /Rcmdr/index.html}> or at
<\href{https://tinyurl.com/Rcmdr}{tinyurl.com/Rcmdr}>.
...
Commander} (version 2.7-0) is shown below. Most menu items lead to dialog
...
simultaneously press the \emph{r} key. On \textbf{Mac OS X} you can usually substitute
...
The resulting dialog box is shown in Figure \ref{fig-6-5}. If you
