...
## Use `setwd()` if needed
setwd("C:/Users/bland/Documents/GitHub/dsc520/data")

## Load the file `data/tidynomicon/person.csv` to `person_df1` using `read.csv`
## Examine the structure of `person_df1` using `str()`
person_df1 <- read.csv("C:/Users/bland/Documents/GitHub/dsc520/data/tidynomicon/person.csv")
str(person_df1)
...
person_df2 <- person_df2 <- read.csv("C:/Users/bland/Documents/GitHub/dsc520/data/tidynomicon/person.csv", stringsAsFactors = FALSE)
str(person_df2)

## Read the file `data/scores.csv` to `scores_df`
## Display summary statistics using the `summary()` function
scores_df <-read.csv("C:/Users/bland/Documents/GitHub/dsc520/data/scores.csv")
summary(scores_df)
...
excel_sheets("C:/Users/bland/Documents/GitHub/dsc520/data/G04ResultsDetail2004-11-02.xls")
...
voter_turnout_df1 <- read_excel("C:/Users/bland/Documents/GitHub/dsc520/data/G04ResultsDetail2004-11-02.xls", skip = 1)
...
voter_turnout_df2 <- read_excel("C:/Users/bland/Documents/GitHub/dsc520/data/G04ResultsDetail2004-11-02.xls", skip = 2)
...
db <- dbConnect(RSQLite::SQLite(), dbname = "C:/Users/bland/Documents/GitHub/dsc520/data/tidynomicon/example.db")
